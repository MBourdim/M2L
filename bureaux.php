...
<head>
    ...
    <title>Bureaux</title>
    <link rel="stylesheet" type="text/css" href="css/bureaux.css">
...
<table>
    <tr class="caption"colspan="2" >
        <td colspan="2" >Etage 1</td>
        <td colspan="2">Etage 2</td>
    </tr>
    <tr>
        <td>A101</td>
        <td>Disponible</td>
        <td>A201</td>
        <td>Ligue d'équitation</td>
    </tr>
    <tr>
        <td>A102</td>
        <td>Disponible</td>
    ...
    <tr>
        ...
        <td>Disponible</td>
        <td>A207</td>
        <td>Ligue de pétanque</td>
    </tr>   
    <tr>
        <td>A108</td>
        <td rowspawn="2">Ligue de rugby</td>
        <td>A208</td>
        <td>Disponible</td>
    </tr>  
    <tr>
